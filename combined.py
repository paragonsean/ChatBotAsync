...
if __name__ == "__main__":
    ...
    print(callAsistantWithTools(tools, "You assist me with calling specific tools to retrieve the temperature or generate random numbers.", prompt=PROMPTS["bbqWeather"]))
